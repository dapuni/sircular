...
class realisasi_distribusi extends CI_Controller {
	...
	public function index($majalah = null,$edisi = null)
	{
		...
		$data['laporan'] = $this->m_sirkulasi->get_laporan_realisasi_distribusi($majalah,$edisi); 
		$data['prev_laporan'] = $this->m_sirkulasi->get_laporan_realisasi_distribusi($majalah,$prev_edisi); 
		$data['content'] = 'laporan/realisasi_distribusi';
	...
	public function cetak($majalah = null,$edisi = null)
	{
		...
		$data['laporan'] = $this->m_sirkulasi->get_laporan_realisasi_distribusi($majalah,$edisi);
		$data['prev_laporan'] = $this->m_sirkulasi->get_laporan_realisasi_distribusi($majalah,$prev_edisi); 
		$this->load->view('laporan/print_realisasi_distribusi',$data);
	}
