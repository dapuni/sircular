...
<body topMargin="0" leftMargin="1">
    <div>
      ...
      <table width="710" cellpadding="1" cellspacing="0" border="0">
        ...
        <tr>
          <td height="20" class="txtPrint1"><?php echo "N.P.W.P : ".$cetak_invoice['npwp_penerbit'] ?></td>
        ...
        <tr>
          ...
          <td valign="top" align="right" class="txtPrint1">:</td>
          <td valign="top"  height="40"  align="right" class="txtPrint1"><b><?php echo date('d-m-Y',$duedate) ?></b></td>
        </tr>
        <tr>
