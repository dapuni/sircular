...
<body topMargin="0" leftMargin="1" onload="window.print()">
<?php 
  ...
  { ?>
    <div>
      ...
      <table width="710" cellpadding="1" cellspacing="0" border="0">
        <tr>
          <td width="450" height="0" class="txtPrint1"><?php echo $detail['alamat'] ?></td>
          <td width="70" valign="top" align="right" class="txtPrint1">No.</td>
          <td width="40" valign="top" align="right" class="txtPrint1">:</td>
          <td width="150" valign="top" align="right" class="txtPrint1"><b><?php echo date('y',strtotime($majalah['date_created']))."/".$detail['nama_majalah']."/0".$majalah['distribution_realization_detail_id'] ?></b></b></td>
        </tr>
        <tr>
        ...
        <tr >
          <td width="25" height="20" valign="top" class="txtPrint1"><?php echo "Tanggal Pengukuhan pkp ".$detail['pkp']?></td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="25" valign="top" class="txtPrint1" rowspan="2"><?php echo "N.P.W.P : ".($npwp[$i] == '') ? "00.000.000.00.0.-000.000" : $npwp[$i] ?></td>
        </tr>
      </table><br>
      <table width="710" cellpadding="1" cellspacing="0" border="0">
        <tr>
