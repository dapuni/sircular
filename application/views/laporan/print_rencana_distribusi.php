...
<head>
	...
	<?php 
		if (isset($excel)) {
			...
			header("Content-Disposition: attachment; filename=Rencana Distribusi.xls");
...
<body>
	...
	<h4>Laporan Rencana Distribusi <?php echo $majalah['nama_majalah'].' EDISI '.$edisi['kode_edisi'] ?></h4>
	...
	<h4  style="padding-top:15px;">Rekapitulasi Rencana Distribusi <?php echo $majalah['nama_majalah'].' EDISI '.$edisi['kode_edisi'] ?></h4>
	<table class="table" style="border:1px solid;" width="100%">
		<tr>
			<th style="border-bottom: 1px solid black;">#</th>
			<th style="border-bottom: 1px solid black;">Kategori</th>
