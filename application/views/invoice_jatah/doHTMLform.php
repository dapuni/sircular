...
<body topMargin="0" leftMargin="1">
    <div>
      ...
      <table width="100%" cellpadding="1" cellspacing="0" border="0">
        ...
        <tr>
          <td width="50%" valign="top" class="txtPrint1"><?php echo "N.P.W.P : ".$cetak_invoice['npwp_penerbit'] ?></td>
        ...
        <tr></tr>
        <tr>
          <td width="50%" valign="top" class="txtPrint1" rowspan="2">N.P.W.P :<?php echo ($cetak_invoice['npwp'] == '') ? "00.000.000.00.0.-000.000" : $cetak_invoice['npwp'] ?></td>
        </tr>
      </table><br>
      <table width="100%" cellpadding="1" cellspacing="0" border="0">
        <tr>
      ...
      <table width="100%" cellpadding="1" cellspacing="0" style="border: double">
        ...
        <tr>
          ...
          <td width="15%" height="60" align="center" align="center" class="txtPrint1" style="border-left: 1px solid;">
