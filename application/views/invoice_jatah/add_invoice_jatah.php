<fieldset>
	<legend>Tambah Invoice Jatah</legend>
	<form action="<?php echo base_url()?>tagihan/invoice_jatah/list_data" method="post">
		<div class="col-xs-2">
		...
		<div class="col-xs-2">
			<button type="submit" class="btn btn-default" id="button" >Buat Invoice Jatah</button>			
		</div>
		<div class="col-xs-12">
			<table class="table">
				<thead>
...
<script type="text/javascript">
	$( document ).ready(function() {
     	$('#button').click(function(){
     		var agent = $('#agent').val();
     		if (agent == 0) {
     			alert('Please select agent carefully');
     			return false;
     		}
     	});
	});
